...
static void test_max_length_word(void) {
  ...
  int index = 0;
  char *input_text =
      "Look thisisaveeeeeerylongwordtypedwithoutusinganyspaces and look again, "
...
static void test_excessive_length_word(void) {
  ...
  int index = 0;
  char *input_text =
      "Look thisisanexcessivelylongwordthatsomeonetypedwithoutusingthespacebar "
      "enough";
...
static void test_max_number_words(void) {
  int actual_word_count;
  int index = 0;
  char *input_text = "Once upon a time, a long while in the past, there lived "
                     "a strange little man who could spin straw into gold";
...
static void test_excessive_number_words(void) {
  ...
  int index = 0;
  char *input_text =
      "Once upon a time, a long while in the past, there lived a strange "
      "little man who could spin straw into pure gold.";
