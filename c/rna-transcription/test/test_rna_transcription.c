...
static void test_failure(const char *dna) { TEST_ASSERT_NULL(to_rna(dna)); }

static void test_transcribes_G_to_C(void) { test_transcription("G", "C"); }

static void test_transcribes_C_to_G(void) { test_transcription("C", "G"); }

static void test_transcribes_T_to_A(void) { test_transcription("T", "A"); }

static void test_transcribes_A_to_U(void) { test_transcription("A", "U"); }

static void test_transcribes_all_occurrences(void) {
  test_transcription("ACGTGGTCTTAA", "UGCACCAGAAUU");
}

static void test_handle_invalid_nucleotide(void) { test_failure("U"); }

static void test_handle_completely_invalid_input(void) { test_failure("XXX"); }
