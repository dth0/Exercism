...
static void test_square_1(void) { TEST_ASSERT(1ull == square(1)); }

static void test_square_2(void) { TEST_ASSERT(2ull == square(2)); }

static void test_square_3(void) { TEST_ASSERT(4ull == square(3)); }

static void test_square_4(void) { TEST_ASSERT(8ull == square(4)); }

static void test_square_16(void) { TEST_ASSERT(32768ull == square(16)); }

static void test_square_32(void) { TEST_ASSERT(2147483648ull == square(32)); }

static void test_square_64(void) {
  TEST_ASSERT(9223372036854775808ull == square(64));
}

static void test_square_0_does_not_exist(void) { TEST_ASSERT(0 == square(0)); }
