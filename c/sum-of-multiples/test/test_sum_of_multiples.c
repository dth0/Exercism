...
static void test_sum_of_multiples_of_3_and_5_up_to_4(void) {
  const unsigned int multiples[] = {3, 5};
  TEST_ASSERT_EQUAL(3,
                    sum_of_multiples(multiples, NUM_OF_ELEMENTS(multiples), 4));
}

static void test_sum_of_multiples_of_3_and_5_up_to_10(void) {
  const unsigned int multiples[] = {3, 5};
  TEST_ASSERT_EQUAL(
      23, sum_of_multiples(multiples, NUM_OF_ELEMENTS(multiples), 10));
}

static void test_sum_of_multiples_of_3_and_5_up_to_100(void) {
  const unsigned int multiples[] = {3, 5};
  TEST_ASSERT_EQUAL(
      2318, sum_of_multiples(multiples, NUM_OF_ELEMENTS(multiples), 100));
}

static void test_sum_of_multiples_of_3_and_5_up_to_1000(void) {
  const unsigned int multiples[] = {3, 5};
  TEST_ASSERT_EQUAL(
      233168, sum_of_multiples(multiples, NUM_OF_ELEMENTS(multiples), 1000));
}
...
static void test_sum_of_multiples_of_1_up_to_100(void) {
  ...
  TEST_ASSERT_EQUAL(
      4950, sum_of_multiples(multiples, NUM_OF_ELEMENTS(multiples), 100));
}
