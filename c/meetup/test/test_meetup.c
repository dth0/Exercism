...
static void test_thursteenth_of_May_2013(void) {
  TEST_ASSERT_EQUAL_INT(16, meetup_day_of_month(2013, 5, "teenth", "Thursday"));
}

static void test_thursteenth_of_June_2013(void) {
  TEST_ASSERT_EQUAL_INT(13, meetup_day_of_month(2013, 6, "teenth", "Thursday"));
}

static void test_thursteenth_of_September_2013(void) {
  TEST_ASSERT_EQUAL_INT(19, meetup_day_of_month(2013, 9, "teenth", "Thursday"));
}
...
static void test_saturteenth_of_February_2013(void) {
  TEST_ASSERT_EQUAL_INT(16, meetup_day_of_month(2013, 2, "teenth", "Saturday"));
}

static void test_saturteenth_of_April_2013(void) {
  TEST_ASSERT_EQUAL_INT(13, meetup_day_of_month(2013, 4, "teenth", "Saturday"));
}
...
static void test_second_Thursday_of_September_2013(void) {
  TEST_ASSERT_EQUAL_INT(12, meetup_day_of_month(2013, 9, "second", "Thursday"));
}
...
static void test_second_Saturday_of_January_2013(void) {
  TEST_ASSERT_EQUAL_INT(12, meetup_day_of_month(2013, 1, "second", "Saturday"));
}
...
static void test_third_Wednesday_of_July_2013(void) {
  TEST_ASSERT_EQUAL_INT(17, meetup_day_of_month(2013, 7, "third", "Wednesday"));
}

static void test_third_Wednesday_of_August_2013(void) {
  TEST_ASSERT_EQUAL_INT(21, meetup_day_of_month(2013, 8, "third", "Wednesday"));
}
...
static void test_third_Thursday_of_October_2013(void) {
  TEST_ASSERT_EQUAL_INT(17, meetup_day_of_month(2013, 10, "third", "Thursday"));
}
...
static void test_fourth_Thursday_of_September_2013(void) {
  TEST_ASSERT_EQUAL_INT(26, meetup_day_of_month(2013, 9, "fourth", "Thursday"));
}
...
static void test_fourth_Saturday_of_January_2013(void) {
  TEST_ASSERT_EQUAL_INT(26, meetup_day_of_month(2013, 1, "fourth", "Saturday"));
}

static void test_fourth_Saturday_of_February_2013(void) {
  TEST_ASSERT_EQUAL_INT(23, meetup_day_of_month(2013, 2, "fourth", "Saturday"));
}
...
static void test_last_Wednesday_of_December_2014(void) {
  TEST_ASSERT_EQUAL_INT(31, meetup_day_of_month(2014, 12, "last", "Wednesday"));
}
